...
import AppMockup from '../assets/beecup-app-mockup.png';
    ...
    <section id="app-section" className="py-4 bg-[#132A13] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-8 md:gap-16 relative z-10">
            <div className="flex-1 space-y-4 md:space-y-6">
                ...
                <p className="text-gray-300 text-base md:text-lg max-w-lg leading-relaxed">Otomatın önünde misin? QR kodu okut, ödemeni yap ve kapağı aç. App üzerinden sipariş ver, Bal Puan kazan.</p>
